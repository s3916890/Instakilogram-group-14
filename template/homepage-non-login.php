...
<head>
    ...
    <link rel="stylesheet" href="../style/homepage-non-login.css">
    ...
    <div class="homepage-container">
        ...
        <main id="main">
            ...
            <div class="post-content">
                <a href="./login.php" class="post">
                    <div class="author">
                        <div class="info-container">
                            <img src="../assets/Demo Instakilogram Design/karma2710.jpeg" class="avatar" alt="avatar">
                            <h1 class="userName">karma.2710</h1>
                        </div>
                        <h2 class="option">Public</h2>
                    </div>
                    <img src="../assets/Demo Instakilogram Design/aesthetic.jpg" class="post-image" alt="post image">
                </a>
                <a href="./login.php" class="post">
                    <div class="author">
                        <div class="info-container">
